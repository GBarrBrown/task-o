  ...
  return knex('tasks').del()
    .then(function () {
      ...
      return knex('tasks').insert([
        ...
        {id: 9, name:'test 8', description:'This is a test input', creation_date:'Thu Jan 25 2019', status: 1},
        {id: 8, name:'test 9', description:'This is a test input', creation_date:'Thu Jan 25 2019', status: 2}
      ]);
    });
};
